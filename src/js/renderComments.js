...
const { commentContainer } = getRefs();

export function renderComments(comments) {
  const markup = comments
    .map(
      ({ avatar, createdAt, author, content, thumbsUp, thumbsDown }) => `
      ...
      <div class="media g-mb-30 media-comment">
        ...
        <div class="media-body u-shadow-v18 g-bg-secondary g-pa-30 rounded">
          <div class="g-mb-15">
            ...
            <span class="g-color-gray-dark-v4 g-font-size-12">${formatDate(
              createdAt,
            )}</span>
          </div>
          <p>${content}</p>
          <ul class="list-inline d-sm-flex my-0">
            <li class="list-inline-item g-mr-20 me-3">
              ...
              >
                <span
                  class="material-icons-round g-pos-rel g-top-1 g-mr-3 me-1"
                >
                  thumb_up
                </span>
                ${thumbsUp}
  ...
  commentContainer.insertAdjacentHTML('beforeend', markup);
}
